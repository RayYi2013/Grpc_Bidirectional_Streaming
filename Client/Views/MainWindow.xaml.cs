...
public partial class MainWindow
{
    ...
    private string GetPlacementFilePath() => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "GrpcBidirectionalStreaming", "client_window.json");
